...
public class Result : RuntimeResult
{
	public Result(
		...
		InteractionCommandError error = InteractionCommandError.Unsuccessful,
		string errorReason = "") : base(error, errorReason)
	{
		IsSuccess = isSuccess;
		Builder = builder;
	...
	public static Task<RuntimeResult> GetTaskFor(EmbedBuilder builder,
		bool isSuccess = false,
		bool isEphemeral = true,
		bool isDefered = false,
		InteractionCommandError error = InteractionCommandError.Unsuccessful,
